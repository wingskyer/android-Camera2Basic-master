...
public class Camera2BasicFragment extends Fragment
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        isoSeekBar =(SeekBar)view.findViewById(R.id.iso);
        isoSeekBar.setOnSeekBarChangeListener(this);
    ...
    //base on Nexcus 6P:[0,10]
    private float valueAF = 0.0f;
    //base on Nexcus 6P:[12,-12]
    private int valueAE = 0;
    //base on Nexcus 6P:[234324552,9516]
